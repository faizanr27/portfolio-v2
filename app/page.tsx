...
const projects = [
  ...
  },
  {
    ...
    tech: ['React', 'Tailwind CSS', 'Framer Motion', 'Shadcn'],
    githubLink: "https://hivee-mind.vercel.app",
    liveLink: 'https://github.com/faizanr27/Hive-Mind-FE',
  },
];
    ...
    <main className="min-h-screen bg-black text-zinc-50 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          {navItems.map((item) => (
            <Link key={item.label} href={item.link}>
              ...
              >
                <span className={`text-sm ${activeSection === item.label ? 'border-b border-orange-400' : ''}`}>
                  {item.label}
                </span>
              </button>
            </Link>
      ...
      <div className="max-w-4xl mx-auto px-4 py-28 -mt-10">
        ...
        <h1 className="text-5xl font-bold mb-4 text-white inline-block">
          <RoughNotation type="highlight" color='#ff4000' show={true} animationDelay={800} strokeWidth={2}>
            Faizan Raza
          </RoughNotation>
        </h1>
        ...
        >
          ...
          <Link href="https://github.com/faizanr27" target="_blank" rel="noopener noreferrer">
            <Button
              variant="outline"
              className="border-zinc-700 hover:border-zinc-500 hover:bg-black/80 hover:text-white/50 bg-black rounded-lg"
            >
          ...
          <Link href="https://linkedin.com/in/faizanr27" target="_blank" rel="noopener noreferrer">
            <Button
              variant="outline"
              className="border-zinc-700 hover:border-zinc-500 hover:bg-black/80 hover:text-white/50 bg-black rounded-lg"
            >
        ...
        >
          ...
          <a href="https://github.com/faizanr27">
            <GithubGraph
              ...
              blockMargin={2}
              // colorPallete={["#2b2b2b", "#4e4e4e", "#707070", "#9b9b9b", "#c7c7c7"]}
              colorPallete={["#2b1a0b", "#7a3e1d", "#b85c2e", "#e67342", "#ff9248"]}
            ...
            >
              <span>{project.title}</span>
                ...
                <Link href={project.githubLink}>
                      <Github size={20} className="hover:scale-125 transition-all" />
                    </Link>
                    <Link href={project.liveLink}>
                      <Globe size={20} className="hover:scale-125 transition-all" />
                    </Link>
                </div>
                </div>
