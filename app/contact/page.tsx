        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <p className="text-zinc-400 mb-6">
              Feel free to reach out through the platforms below or send an email. I'm always open to discussing new
              projects, creative ideas, or opportunities.
            </p>

            <div className="space-y-4">
              <a
                href="mailto:contact@faizanraza.com"
          ...
          <div>
            ...
            <form className="space-y-4">
              ...
              <Button className="w-full bg-zinc-800 hover:bg-zinc-700 text-white">Send Message</Button>
            </form>
          </div>
        </div>
      </div>
